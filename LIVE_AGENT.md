...
- Continue Phase 4 by using the explicit sibling-novelty retry trace plus the route no-double-write regression as guardrails while reconciling the remaining reply/runtime ownership boundary
