...
import { Bug, ImagePlus, Lightbulb, MessageSquareText, Trash2 } from "lucide-react";
            ...
            <div className="space-y-5">
              ...
              <div className="grid gap-5 lg:grid-cols-2">
                <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-5">
                  ...
                  />
                  <p className="mt-2 text-[11px] text-zinc-500">{activeFeedbackDraft.trim().length} chars</p>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center gap-2 text-center">
                      ...
                      <p className="text-xs text-zinc-300">Drag and drop files here, or click to upload</p>
                    ...
                    <div className="mt-3 grid gap-3 sm:grid-cols-2">
                      {feedbackImages.map((image) => (
                        ...
                        >
                          ...
                          <p className="text-[11px] text-zinc-500">{formatFileSize(image.file.size)}</p>
                        </div>
                      ))}
                    </div>
                  ) : null}
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          {normalizeFeedbackStatus(entry.status) === "open" ? (
                            <>
                              ...
                              >
                                {feedbackStatusUpdatingIds[entry.id] ? "Updating" : "Mark resolved"}
                              </button>
                              <button
                                type="button"
                                disabled={Boolean(feedbackStatusUpdatingIds[entry.id])}
                              ...
                              >
                                {feedbackStatusUpdatingIds[entry.id] ? "Updating" : "Mark cancelled"}
                              </button>
                            </>
                          ) : (
                            <button
