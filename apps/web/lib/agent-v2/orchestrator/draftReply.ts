  ...
  if (isRevisionRequest) {
    if (args.draftPreference === "voice_first") {
      return buildCadenceReply({
        ...
        followUp: {
          ...
          balanced: [
            "does this feel closer to how you'd post it?",
            "want another pass or is this good?",
            "does this version land better?",
          ],
          warm: [
            "how does this feel now, and do you want another tweak?",
            "does this feel like you, or should we tune it a bit more?",
          ],
        },
        profile: cadenceProfile,
        seed: `${seed}|rev|voice`,
    ...
    if (args.draftPreference === "growth_first") {
      return buildCadenceReply({
        ...
        followUp: {
          ...
          balanced: [
            "want it punchier or does this hit?",
            "do you want another tweak?",
            "should i refine it more?",
          ],
          warm: [
            "how does this hit now, and do you want me to tweak the hook more?",
            "does this feel right for growth, or should i tune it further?",
          ],
        },
        profile: cadenceProfile,
    ...
    if (mentionsTrim(issuesFixed)) {
      return buildCadenceReply({
        ...
        followUp: {
          ...
          balanced: [
            "want me to tighten it one more step?",
            "does this feel post-ready?",
          ],
          warm: [
            "does this feel clean enough to post, or should i trim one more pass?",
            "how does this flow for you now?",
          ],
        },
        profile: cadenceProfile,
        seed: `${seed}|rev|trim`,
    ...
    return buildCadenceReply({
      ...
      followUp: {
        ...
        warm: [
          "how does this feel now, and do you want any tweaks?",
          "does this feel better, or should i keep tuning it?",
        ],
      },
      profile: cadenceProfile,
    ...
    return buildCadenceReply({
      ...
      followUp: {
        ...
        balanced: [
          ...
          "does it feel right, or should i adjust it?",
          "want any edits?",
        ],
        warm: [
          "how does this feel to you, and do you want any tweaks?",
          "does this sound like you, or should we tune it together?",
        ],
      },
      profile: cadenceProfile,
  ...
  if (args.draftPreference === "growth_first") {
    return buildCadenceReply({
      ...
      followUp: {
        ...
        balanced: [
          "do you want a softer or punchier version?",
          "should i tune the tone?",
          "want me to push it further or keep it balanced?",
        ],
        warm: [
          "how does this land for you, and should i tune the tone?",
          "does this growth framing feel right, or should i adjust it?",
        ],
      },
      profile: cadenceProfile,
  ...
  if (mentionsTrim(issuesFixed)) {
    return buildCadenceReply({
      ...
      followUp: {
        ...
        balanced: [
          "want to trim it even more?",
          "does this feel good to post?",
        ],
        warm: [
          "how does this read now, and do you want another trim pass?",
          "does this feel post-ready, or should i tighten a bit more?",
        ],
      },
      profile: cadenceProfile,
  ...
  if (
    ...
    return buildCadenceReply({
      ...
      followUp: {
        ...
        balanced: [
          "want any tweaks before you post?",
          "does this feel right?",
          "want to adjust tone, hook, or length?",
        ],
        warm: [
          "how does this feel, and do you want any tweaks before posting?",
          "does this feel like your voice, or should we adjust tone, hook, or length?",
        ],
      },
      profile: cadenceProfile,
  ...
  return buildCadenceReply({
    ...
    followUp: {
      ...
      balanced: [
        ...
        "should we tune tone, hook, or length?",
        "does this feel on-brand for you?",
      ],
      warm: [
        "how does this feel to you, and what would you like to tweak?",
        "does this feel on-brand for you, or should we tune tone, hook, or length?",
      ],
    },
    profile: cadenceProfile,
